...
| `src/features/reports/accounting.css` | El módulo deja de arrastrar la página en el teléfono; las cuentas comparten rejilla |
| `src/features/reports/AccountingPanel.tsx` | `LedgerTable` acepta anchos de columna; las cuatro cuentas los usan |
| `src/app/styles.css` | La separación entre córdobas y dólares pesa más que los títulos que separa |
